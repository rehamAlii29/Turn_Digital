...
import 'package:flutter_base/src/Core/Utils/Validation/Implementation/EmailValidator/email_validator.dart';
...
import 'Implementation/NameValidator/name_validator.dart';
...
class AppValidator {
  ...
  static NameValidator get nameValidator => NameValidator.instance;
}
