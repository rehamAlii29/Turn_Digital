...
/// Depends on loading_animation_widget  and flutter_spinkit Packages
 class Loading extends StatelessWidget {
  ...
  factory Loading.pulse({
    ...
    return Loading._(
      Stack(
        ...
        children: [
          SpinKitPulse(
            color: color??_loadingColor,duration: Duration(seconds: durationSeconds),
            size: size,
          ),
           CircleAvatar(
  ...
  factory Loading.bouncingBall({
    ...
    return Loading._(
      LoadingAnimationWidget.bouncingBall(color: color??_loadingColor, size: size),
      isCentered: isCentered,
      backgroundColor: backgroundColor,
    );
  }
  ...
  factory Loading.discreteCircle({
    ...
    return Loading._(
      LoadingAnimationWidget.discreteCircle(color: color??_loadingColor, size: size),
      isCentered: isCentered,
      backgroundColor: backgroundColor,
    );
  }
  ...
  factory Loading.stretchedDots({
    ...
    return Loading._(
      LoadingAnimationWidget.stretchedDots(color: color??_loadingColor, size: size),
      isCentered: isCentered,
      backgroundColor: backgroundColor,
    );
  }
  ...
  factory Loading.hexagonDots({
    ...
    return Loading._(
      LoadingAnimationWidget.hexagonDots(color: color??_loadingColor, size: size),
      isCentered: isCentered,
      backgroundColor: backgroundColor,
    );
  }
  ...
  factory Loading.twoRotatingArc({
    ...
    return Loading._(
      LoadingAnimationWidget.twoRotatingArc(color: color??_loadingColor, size: size),
      isCentered: isCentered,
      backgroundColor: backgroundColor,
    );
  }
  ...
  factory Loading.fourRotatingDots({
    ...
    return Loading._(
      LoadingAnimationWidget.fourRotatingDots(color: color??_loadingColor, size: size),
      isCentered: isCentered,
      backgroundColor: backgroundColor,
    );
  }
  ...
  factory Loading.staggeredDotsWave({
    ...
    return Loading._(
      LoadingAnimationWidget.staggeredDotsWave(color: color??_loadingColor, size: size),
      isCentered: isCentered,
      backgroundColor: backgroundColor,
    );
  }
  ...
  factory Loading.threeRotatingDots({
    ...
    return Loading._(
      LoadingAnimationWidget.threeRotatingDots(color: color??_loadingColor, size: size),
      isCentered: isCentered,
      backgroundColor: backgroundColor,
    );
  }
  ...
  factory Loading.waveDots({
    ...
    return Loading._(
      LoadingAnimationWidget.waveDots(color: color??_loadingColor, size: size),
      isCentered: isCentered,
      backgroundColor: backgroundColor,
    );
  }
